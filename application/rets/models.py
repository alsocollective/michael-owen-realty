...
class ResidentialProperty(models.Model):
	...
	community = models.CharField(max_length=1000, blank=True)
	community_code = models.CharField(max_length=1000, blank=True)
	cross_st = models.CharField(max_length=1000, blank=True)
	disp_addr = models.CharField(max_length=100, blank=True)
	drive = models.CharField(max_length=1000, blank=True)
	...
	extras = models.CharField(max_length=1000, blank=True)
	...
	gar_type = models.CharField(max_length=1000, blank=True)
	heat_inc = models.CharField(max_length=100, blank=True)
	fuel = models.CharField(max_length=900, blank=True)
	heating = models.CharField(max_length=1000, blank=True)
	...
	lease_term = models.CharField(max_length=1000, blank=True)
	legal_desc = models.CharField(max_length=1000, blank=True)
	...
	rltr = models.CharField(max_length=1000, blank=True)
	...
	municipality_district = models.CharField(max_length=1000, blank=True)
	municipality_code = models.CharField(max_length=1000, blank=True)
	oth_struc1_out = models.CharField(max_length=1000, blank=True)
	oth_struc2_out = models.CharField(max_length=1000, blank=True)
	...
	prop_feat1_out = models.CharField(max_length=1000, blank=True)
	prop_feat2_out = models.CharField(max_length=1000, blank=True)
	prop_feat3_out = models.CharField(max_length=1000, blank=True)
	prop_feat4_out = models.CharField(max_length=1000, blank=True)
	prop_feat5_out = models.CharField(max_length=1000, blank=True)
	prop_feat6_out = models.CharField(max_length=1000, blank=True)
	...
	rm1_dc1_out = models.CharField(max_length=1000, blank=True)
	rm1_dc2_out = models.CharField(max_length=1000, blank=True)
	rm1_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm10_dc1_out = models.CharField(max_length=1000, blank=True)
	rm10_dc2_out = models.CharField(max_length=1000, blank=True)
	rm10_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm11_dc1_out = models.CharField(max_length=1000, blank=True)
	rm11_dc2_out = models.CharField(max_length=1000, blank=True)
	rm11_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm12_dc1_out = models.CharField(max_length=1000, blank=True)
	rm12_dc2_out = models.CharField(max_length=1000, blank=True)
	rm12_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm2_dc1_out = models.CharField(max_length=1000, blank=True)
	rm2_dc2_out = models.CharField(max_length=1000, blank=True)
	rm2_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm3_dc1_out = models.CharField(max_length=1000, blank=True)
	rm3_dc2_out = models.CharField(max_length=1000, blank=True)
	rm3_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm4_dc1_out = models.CharField(max_length=1000, blank=True)
	rm4_dc2_out = models.CharField(max_length=1000, blank=True)
	rm4_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm5_dc1_out = models.CharField(max_length=1000, blank=True)
	rm5_dc2_out = models.CharField(max_length=1000, blank=True)
	rm5_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm6_dc1_out = models.CharField(max_length=1000, blank=True)
	rm6_dc2_out = models.CharField(max_length=1000, blank=True)
	rm6_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm7_dc1_out = models.CharField(max_length=1000, blank=True)
	rm7_dc2_out = models.CharField(max_length=1000, blank=True)
	rm7_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm8_dc1_out = models.CharField(max_length=1000, blank=True)
	rm8_dc2_out = models.CharField(max_length=1000, blank=True)
	rm8_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	rm9_dc1_out = models.CharField(max_length=1000, blank=True)
	rm9_dc2_out = models.CharField(max_length=1000, blank=True)
	rm9_dc3_out = models.CharField(max_length=1000, blank=True)
	...
	vend_pis = models.CharField(max_length=1000, blank=True)
	sewer = models.CharField(max_length=1000, blank=True)
	...
	st = models.CharField(max_length=1000, blank=True)
	...
	zoning = models.CharField(max_length=1000, blank=True)
...
class Area(models.Model):
	...
	# payloadText = models.CharField(max_length=10000)
	def __unicode__(self):
		return self.text
